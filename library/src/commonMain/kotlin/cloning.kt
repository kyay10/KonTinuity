...
internal fun <T, R> Continuation<T>.clone(prompt: Prompt<R>, replacement: Hole<R>): Continuation<T> =
...
internal interface CloneableContinuation<T> : Continuation<T> {
  fun <R> clone(prompt: Prompt<R>, replacement: Hole<R>): CloneableContinuation<T>
}