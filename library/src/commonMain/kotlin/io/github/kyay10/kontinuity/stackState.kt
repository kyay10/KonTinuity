...
public suspend fun <T, R, Region> MultishotScope<Region>.runStackState(
  value: T,
  body: suspend context(StackState<T>) MultishotScope<Region>.() -> R
): R = runState(listOf(value), body)