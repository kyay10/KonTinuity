...
class AutomaticDifferentiationTest {
  ...
  fun example() = runTestCC {
    forwards(2.0) { prog(it) } shouldEq 15.0
    backwards(2.0) { prog(it) } shouldEq 15.0
    backwardsAutoClose(2.0) { prog(it) } shouldEq 15.0

    forwards(3.0) { prog(it) } shouldEq 30.0
    backwards(3.0) { prog(it) } shouldEq 30.0
    backwardsAutoClose(3.0) { prog(it) } shouldEq 30.0

    forwards(0.0) { prog(it) } shouldEq 3.0
    ...
    forwards(0.0) { progExp(it) } shouldEq mathExp(1.0)
    backwards(0.0) { progExp(it) } shouldEq mathExp(1.0)
    backwardsAutoClose(0.0) { progExp(it) } shouldEq mathExp(1.0)
    val one = 1.0
