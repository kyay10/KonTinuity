...
private class Iterate2<A>(field: Region.Field<(suspend (Unit) -> A)?>, p: HandlerPrompt<EffectfulIterator2<A>>) :
...
suspend fun <A> Region.iterate2(block: suspend Generator<A>.() -> Unit) = handle {
