...
context(h: HandlerPrompt<Region, R>)
inline fun <Region, Error, R> MultishotScope<Region>.Raise(crossinline transform: (Error) -> R): Raise<Error> =
  object : Raise<Error> {
...
suspend fun <Region: OuterRegion, OuterRegion, T> MultishotScope<Region>.insert(list: List<T>, element: T): PersistentList<T> {
