...
class LazyMemoTest {
  ...
  fun baseline() = runTestCC {
    ...
    exactReify {
      ...
      if (u == 0) None else Some(Triple(flip(), x, x))
    ...
    expensiveComputation shouldEq 4
  }
  ...
  fun asyncAwait() = runTestCC {
    ...
    expensiveComputation shouldEq 12
  }
  ...
  fun stupidLazy() = runTestCC {
    ...
    expensiveComputation shouldEq 2
  }
  ...
  fun testl() = runTestCC {
    ...
    exactReify { testl1() } shouldContainExactlyInAnyOrder
      listOf(
    ...
    exactReify { testl2() } shouldContainExactlyInAnyOrder
      listOf(
        Probable(0.125, Value.Leaf(6 to 6)),
        Probable(0.125, Value.Leaf(4 to 4)),
        Probable(0.125, Value.Leaf(3 to 3)),
    ...
    expensiveComputation shouldEq 4
    expensiveComputation = 0
    sampleRejection(random(1).selector(), 10) { testl1() } shouldContainExactlyInAnyOrder
      listOf(Probable(0.59999999999999998, Value.Leaf(2 to 2)), Probable(0.40000000000000002, Value.Leaf(1 to 1)))
    expensiveComputation shouldEq 10
    expensiveComputation = 0
    sampleRejection(random(1).selector(), 10) { testl2() } shouldContainExactlyInAnyOrder
      listOf(Probable(0.1, Value.Leaf(4 to 4)), Probable(0.4, Value.Leaf(2 to 2)), Probable(0.5, Value.Leaf(1 to 1)))
    expensiveComputation shouldEq 2
    context(_: Probabilistic, _: Memory)
    suspend fun testl3(): Triple<Int, Boolean, Int> {
      val u = (1..2).uniformly()
      val x = expensiveFunction(listOf(10 * u, 100 * u).uniformly())
      return Triple(u, flip(), x)
    }
    expensiveComputation = 0
    exactReify { testl3() } shouldContainExactlyInAnyOrder
      listOf(
    ...
    expensiveComputation = 0
    exactReify { testl4() } shouldContainExactlyInAnyOrder
      listOf(
        Probable(0.125, Value.Leaf(Triple(2, true, 200))),
        Probable(0.125, Value.Leaf(Triple(2, true, 20))),
        Probable(0.125, Value.Leaf(Triple(2, false, 200))),
    ...
    expensiveComputation shouldEq 8
    expensiveComputation = 0
    sampleRejection(random(1).selector(), 10) { testl3() } shouldContainExactlyInAnyOrder
      listOf(
    ...
    expensiveComputation shouldEq 10
    expensiveComputation = 0
    sampleImportance(random(1).selector(), 10) { testl3() } shouldContainExactlyInAnyOrder
      listOf(
        Probable(0.125, Value.Leaf(Triple(2, true, 200))),
        Probable(0.125, Value.Leaf(Triple(2, true, 20))),
        Probable(0.125, Value.Leaf(Triple(2, false, 200))),
    ...
    expensiveComputation shouldEq 4
    expensiveComputation = 0
    sampleRejection(random(1).selector(), 10) { testl4() } shouldContainExactlyInAnyOrder
      listOf(
        Probable(0.2, Value.Leaf(Triple(2, true, 20))),
    ...
    expensiveComputation shouldEq 10
    expensiveComputation = 0
    sampleImportance(random(1).selector(), 10) { testl4() } shouldContainExactlyInAnyOrder
      listOf(
        Probable(0.125, Value.Leaf(Triple(2, true, 200))),
        Probable(0.125, Value.Leaf(Triple(2, true, 20))),
        Probable(0.125, Value.Leaf(Triple(2, false, 200))),
    ...
    expensiveComputation = 0
    exactReify { testl51() } shouldContainExactlyInAnyOrder
      listOf(
        Probable(0.125, Value.Leaf(6 to 6)),
        Probable(0.125, Value.Leaf(4 to 4)),
        Probable(0.125, Value.Leaf(3 to 3)),
    ...
    expensiveComputation = 0
    exactReify { testl52() } shouldContainExactlyInAnyOrder
      listOf(
        Probable(0.125, Value.Leaf(6 to 6)),
        Probable(0.125, Value.Leaf(4 to 4)),
        Probable(0.125, Value.Leaf(3 to 3)),
    ...
    expensiveComputation = 0
    exactReify { testl54() } shouldContainExactlyInAnyOrder
      listOf(
